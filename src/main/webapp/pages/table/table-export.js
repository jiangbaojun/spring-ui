...
function initTable() {
    $('#myTable').bootstrapTable({
        ...
        exportTypes:['json', 'xml', 'png', 'csv', 'txt', 'sql', 'doc', 'excel', 'xlsx', 'pdf'],  //导出文件类型
        ...
        columns : [
            ...
            {title:'姓名', field:'xm',sortable:true},
            {title:'手机', field:'sj'},
            {title:'入职日期', field:'rzrq', align:'center',sortable:true}, 
            {title:'职务', field :'zw', sortable:true },
            {title:'部门', field :'bm', sortable:true },
